...
export default function CaminhoScreen() {
  ...
  const { caminho, loading: caminhoLoading, refetch: refetchCaminho } = useCaminho(cicatrizacao?.id || null);

  useFocusEffect(useCallback(() => { refetchCaminho(); }, [cicatrizacao?.id]));
        ...
        >
          {cicLoading ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyTitle}>Nenhuma tatuagem ativa</Text>
              <Text style={styles.emptySubtitle}>
                Adicione uma tatuagem na tela inicial para começar o acompanhamento da sua cura.
              </Text>
            </View>
          ) : (
            <>
